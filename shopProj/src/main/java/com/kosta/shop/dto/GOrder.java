...
public class GOrder {
	...
	public GOrder(Integer num, String userid, String gCode, String gName, Integer gPrice, String gSize, String gColor,
			Integer gAmount, String gImage, Integer orderinfo_num) {
		super();
		this.num = num;
		this.userid = userid;
		this.gCode = gCode;
