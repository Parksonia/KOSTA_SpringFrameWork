	...
	<form action="boardWrite" method="post" enctype="multipart/form-data">
		...
		<table>
			<tr>
				...
				<td class="td_right"><input type="text" name="writer" id="writer" value="${member.id}" readonly></td> <!-- disabled="disabled" : form태그에 값을 넘기지 못함 수정 못하게 하려면 readonlly로 해야함 -->
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="td_right">
				<img src="<c:url value="/resources/image/plus.png"/>" style="width: 100px;" alt="이미지선택" id="preview" onclick="document.getElementById('file').click();">
